...
var vBmapIndex = 0;
void WM3_AdvanceBmap()
{ 
	vBmapIndex = cycle(vBmapIndex + 1, 0, WM3_vNumBmap - 1); 
}

void WM3_drawTex_startup()
{
	while(WM3_vNumBmap == 0)
		wait(1);
		
	on_mouse_right = WM3_AdvanceBmap;
	while(1)
	{
		draw_quad(WM3_bmapBmapList[vBmapIndex], vector(0, 200, 0), nullvector, NULL, NULL, NULL, 100, 0);
		wait (1);
	}
}
